...
class CodeDemo extends Component {
    ...
    render() {
        ...
        return (
            <React.Fragment>
                <div
                    className='code-running-demo'
                    ref={this.demoEl}
                />
                {
                    codeHtml && (
                        <div className={`code-text-demo-wrapper${shouldExpand ? ' _active' : ''}`}>
                            {
                                shouldExpand && (
                                    <React.Fragment>
                                        {
                            ...
                            <div className='toggle-btn-wrapper' >
                                <span className='toggle-btn' onClick={this.toggle}>{shouldExpand ? '隐藏代码' : '显示代码'}</span>
                            </div>
                        </div>
                    )
                }
