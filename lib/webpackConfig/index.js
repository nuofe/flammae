...
module.exports = function flammaeWebpackConfigFactory({
    ...
    const flammaeJsFile = resolveApp(fileSchema.flammaeJsFile);
    const appDefaultDist = resolveApp(fileSchema.appDistDir);
    const appFlammae = resolveApp(fileSchema.appFlammaeDir);
    const appTheme = resolveApp(fileSchema.appThemeDir);
    const nodeModules = [
        'node_modules',
            ...
            rules: [
                ...
                },
                {
                    oneOf: [
                        ...
                        {
                            test: /\.(js|jsx)$/,
                            include: [appTheme, appFlammae, templates],
